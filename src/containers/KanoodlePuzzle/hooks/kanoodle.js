...
import webWorker from "../../../worker/app.worker"
...
export default function useKanoodle() {
    ...
    */
        ...
        try {
            if (typeof (Worker) !== "undefined") {
                ...
                if (window.Worker) {
                    ...
                    WebWorker.addEventListener('message', MsgHandler);
    ...
    function Initialise() {
        ...
        console.log("Using " + Pentominoes.length + " pentominoes: ", Pentominoes);
        //    Debug("Using " + Pentominoes.length + " pentominoes: ", Pentominoes);
        for (i = 0; i < Pentominoes.length; i++) {
            console.log("Iternation: ", i, " input: ", Pentominoes[i])
            Shapes[i] = {}
            Shapes[i].Layout = [];
            ...
            for (k = 0; k < 3; k++) {
                ...
                console.log("CurShape: ", CurShape, " k: ", k)
                switch (k) {
                    case 0:
    ...
    function DrawWorkBoard(Board) {
        console.log("DrawWorkBoard: ", Board)
        var Row;
        var Col;
        var Table;
